    ...
    return function(e) {
      ...
      function w(e, t) {
        if (null !== e && "undefined" != typeof e)
          if ("object" == typeof e || n(e) || (e = [e]), n(e))
            ...
            for (var s in e)
              e.hasOwnProperty(s) && t.call(null, e[s], s, e);
      }
      function x() {
        function e(e, r) {
          "object" == typeof t[r] && "object" == typeof e ? t[r] = x(t[r], e) : t[r] = e;
        }
        for (var t = {},
            r = 0,
      ...
      function b(e, t, r) {
        return w(t, function(t, n) {
          r && "function" == typeof t ? e[n] = S(t, r) : e[n] = t;
        }), e;
      }
      var S = r(3),
      ...
      n.prototype.request = function(e) {
        "string" == typeof e && (e = s.merge({url: arguments[0]}, arguments[1])), e = s.merge(o, this.defaults, {method: "get"}, e), e.baseURL && !a(e.url) && (e.url = c(e.baseURL, e.url));
        var t = [u, void 0],
            r = Promise.resolve(e);
      ...
      e.exports = {
        transformRequest: [function(e, t) {
          return s(t, "Content-Type"), o.isFormData(e) || o.isArrayBuffer(e) || o.isStream(e) || o.isFile(e) || o.isBlob(e) ? e : o.isArrayBufferView(e) ? e.buffer : o.isURLSearchParams(e) ? (n(t, "application/x-www-form-urlencoded;charset=utf-8"), e.toString()) : o.isObject(e) ? (n(t, "application/json;charset=utf-8"), JSON.stringify(e)) : e;
        }],
      ...
      e.exports = function(e) {
        ...
        var t;
        return "function" == typeof e.adapter ? t = e.adapter : "undefined" != typeof XMLHttpRequest ? t = r(10) : "undefined" != typeof process && (t = r(10)), Promise.resolve(e).then(t).then(function(t) {
      ...
      var n = r(2),
          ...
          u = r(16),
          a = r(12),
          c = "undefined" != typeof window && window.btoa || r(17);
      e.exports = function(e) {
        return new Promise(function(t, f) {
          ...
          if (l.open(e.method.toUpperCase(), s(e.url, e.params, e.paramsSerializer), !0), l.timeout = e.timeout, l[h] = function() {
            ...
            f(a("Network Error", e)), l = null;
          }, l.ontimeout = function() {
            f(a("timeout of " + e.timeout + "ms exceeded", e, "ECONNABORTED")), l = null;
          }, n.isStandardBrowserEnv()) {
            var v = r(18),
                w = e.withCredentials || u(e.url) ? v.read(e.xsrfCookieName) : void 0;
          ...
          "function" == typeof e.progress && ("post" === e.method || "put" === e.method ? l.upload.addEventListener("progress", e.progress) : "get" === e.method && l.addEventListener("progress", e.progress)), void 0 === p && (p = null), l.send(p);
        });
      };
    }, function(e, t, r) {
      "use strict";
      ...
      e.exports = function(e) {
        ...
        return e ? (n.forEach(e.split("\n"), function(e) {
          o = e.indexOf(":"), t = n.trim(e.substr(0, o)).toLowerCase(), r = n.trim(e.substr(o + 1)), t && (s[t] = s[t] ? s[t] + ", " + r : r);
        }), s) : s;
      };
    }, function(e, t, r) {
      "use strict";
      ...
      function n(e) {
        for (var t,
            ...
            i = "",
            u = 0,
            a = o; s.charAt(0 | u) || (a = "=", u % 1); i += a.charAt(63 & t >> 8 - u % 1 * 8)) {
          if (n = s.charCodeAt(u += .75), n > 255)
            throw new r;
          t = t << 8 | n;
        }
        return i;
      ...
      e.exports = n.isStandardBrowserEnv() ? function() {
        return {
          write: function(e, t, r, o, s, i) {
            var u = [];
            u.push(e + "=" + encodeURIComponent(t)), n.isNumber(r) && u.push("expires=" + new Date(r).toGMTString()), n.isString(o) && u.push("path=" + o), n.isString(s) && u.push("domain=" + s), i === !0 && u.push("secure"), document.cookie = u.join("; ");
          },
          read: function(e) {
