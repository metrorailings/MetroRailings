  ...
  (function() {
    ...
    (function(def) {
      ...
      def(AST_Binary, function(pure_getters) {
        switch (this.operator) {
          ...
          case "||":
            return this.left._eq_null(pure_getters) && this.right._eq_null(pure_getters);
          default:
            return false;
        }
      });
      def(AST_Assign, function(pure_getters) {
        return this.operator == "=" && this.right._eq_null(pure_getters);
      });
      def(AST_Conditional, function(pure_getters) {
        return this.consequent._eq_null(pure_getters) || this.alternative._eq_null(pure_getters);
      });
    ...
    (function(def) {
      ...
      def(AST_Dot, function(compressor) {
        return this.expression.may_eq_null(compressor) || this.expression.has_side_effects(compressor);
      });
      def(AST_Sub, function(compressor) {
        return this.expression.may_eq_null(compressor) || this.expression.has_side_effects(compressor) || this.property.has_side_effects(compressor);
      });
      def(AST_Seq, function(compressor) {
    ...
    (function(def) {
      ...
      def(AST_Dot, function(compressor, first_in_statement) {
        if (this.expression.may_eq_null(compressor))
          return this;
